...
_This plan is the single source of truth for build sequencing. When in doubt, follow canon. When canon conflicts, follow the authority chain in `CLAUDE.md`. When the canon is silent, make the simplest decision that doesn't contradict any canon, log it in `DECISIONS_LOG.md`, and proceed._
