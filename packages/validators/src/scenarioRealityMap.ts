 ...
 */
export const comparisonTypeSchema = z.enum(['maps', 'paths', 'nodes']);
 ...
 * Key driver schema
 */
export const keyDriverSchema = z
  .object({
 ...
 */
export const opportunityFactorSchema = z
  .object({
    id: z.string().optional(),
    category: z.string().min(1).max(100),
    name: z.string().min(1).max(200),
 ...
 */
export const mitigationStrategySchema = z
  .object({
    id: z.string().optional(),
 ...
 * Edge trigger schema
 */
export const edgeTriggerSchema = z
  .object({
 ...
 */
export const realityMapParametersSchema = z
  .object({
    ...
    probabilityModel: probabilityModelTypeSchema
      .optional()
...
export const createComparisonSchema = z
  ...
  .refine(
    (data) =>
      (data.realityMapIds && data.realityMapIds.length > 0) ||
...
export const listRealityMapsQuerySchema = z.object({
  ...
  suiteId: z.string().uuid().optional(),
  sortBy: z
    .enum(['created_at', 'updated_at', 'name', 'total_nodes'])
    .optional()
    .default('created_at'),
...
export const listRealityMapPathsQuerySchema = z.object({
  ...
  minOpportunityScore: z.coerce.number().int().min(0).max(100).optional(),
  sortBy: z
    .enum(['probability', 'risk', 'opportunity'])
    .optional()
    .default('probability'),
  sortOrder: z.enum(['asc', 'desc']).optional().default('desc'),
  limit: z.coerce.number().int().min(1).max(100).optional().default(20),
 ...
 */
export const realityMapSchema = z
  .object({
    id: z.string().uuid(),
    orgId: z.string().uuid(),
 ...
 */
export const realityMapNodeSchema = z
  .object({
    id: z.string().uuid(),
 ...
 */
export const realityMapEdgeSchema = z
  .object({
    id: z.string().uuid(),
    realityMapId: z.string().uuid(),
    parentNodeId: z.string().uuid(),
 ...
 */
export const realityMapPathSchema = z
  .object({
    id: z.string().uuid(),
    realityMapId: z.string().uuid(),
 ...
 */
export const realityMapAuditLogSchema = z
  .object({
    id: z.string().uuid(),
    realityMapId: z.string().uuid(),
 ...
 */
export const realityMapGraphDataSchema = z
  .object({
 ...
 * Path summary schema
 */
export const realityPathSummarySchema = z
  .object({
    pathId: z.string(),
    title: z.string(),
 ...
 */
export const detectedContradictionSchema = z
  .object({
    id: z.string(),
 ...
 */
export const detectedCorrelationSchema = z
  .object({
    id: z.string(),
 ...
 */
export const outcomeUniverseSchema = z
  .object({
 ...
 */
export const pathComparisonResultSchema = z
  .object({
    path1Id: z.string(),
    path2Id: z.string(),
 ...
 */
export const narrativeDeltaResultSchema = z
  .object({
 ...
 */
export const realityMapAnalysisResponseSchema = z
  .object({
    mapId: z.string(),
...
export type CreateRealityMapNodeInput = z.infer<
  typeof createRealityMapNodeSchema
>;
export type UpdateRealityMapNodeInput = z.infer<
  typeof updateRealityMapNodeSchema
>;
export type CreateRealityMapEdgeInput = z.infer<
  typeof createRealityMapEdgeSchema
>;
...
export type ListRealityMapNodesQuery = z.infer<
  typeof listRealityMapNodesQuerySchema
>;
export type ListRealityMapPathsQuery = z.infer<
  typeof listRealityMapPathsQuerySchema
>;
export type ListRealityMapAuditQuery = z.infer<
  typeof listRealityMapAuditQuerySchema
>;
export type GetRealityMapGraphQuery = z.infer<
  typeof getRealityMapGraphQuerySchema
>;
export type GetRealityMapAnalysisQuery = z.infer<
  typeof getRealityMapAnalysisQuerySchema
>;
