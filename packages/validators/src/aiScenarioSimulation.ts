...
export const aiSimulationConfigSchema = z
  .object({
...
export const aiAgentPersonaRefSchema = z
  .object({
...
export const aiScenarioTurnMetadataSchema = z
  .object({
...
export const aiScenarioRecommendedActionSchema = z
  .object({
...
export const aiSimRiskRadarSnapshotSchema = z
  .object({
...
export const unifiedGraphContextSchema = z
  .object({
    relevantNodes: z
      .array(
        z.object({
...
export const strategicIntelContextSchema = z
  .object({
...
export const competitiveContextSchema = z
  .object({
    topCompetitors: z
      .array(
        z.object({
...
export const reputationContextSchema = z
  .object({
...
export const crisisContextSchema = z
  .object({
    activeIncidents: z
      .array(
        z.object({
...
export const aiContextSnapshotSchema = z
  .object({
    capturedAt: z.coerce
      .date()
      .optional()
...
export const aiScenarioSeedSourceSchema = z
  .object({
    sourceType: z.enum([
      'playbook',
      'narrative',
...
export const createAISimulationSchema = z
  .object({
...
export const updateAISimulationSchema = z
  .object({
...
export const listAISimulationsSchema = z
  .object({
...
export const listSimulationRunsSchema = z
  .object({
    status: aiRunStatusSchema.optional(),
    riskLevel: aiScenarioRiskLevelSchema.optional(),
    sortBy: z
      .enum(['run_number', 'created_at', 'started_at', 'status'])
      .optional()
      .default('created_at'),
    sortOrder: z.enum(['asc', 'desc']).optional().default('desc'),
...
export const runUntilConvergedSchema = z
  .object({
...
export const postAgentFeedbackSchema = z
  .object({
...
export const listRunTurnsSchema = z
  .object({
...
export const listRunMetricsSchema = z
  .object({
...
export const listRunOutcomesSchema = z
  .object({
...
export const computeRunMetricsSchema = z
  .object({
...
export const summarizeOutcomesSchema = z
  .object({
...
export const aiSimListAuditLogsSchema = z
  .object({
...
export const archiveSimulationSchema = z
  .object({
...
export const archiveRunSchema = z
  .object({
    reason: z.string().max(500).optional(),
  })
  .strict();
...
export const simulationIdParamSchema = z
  .object({
    id: z.string().uuid(),
  })
  .strict();

export const aiSimRunIdParamSchema = z
  .object({
    runId: z.string().uuid(),
  })
  .strict();

export const simulationAndRunParamSchema = z
  .object({
    id: z.string().uuid(),
    runId: z.string().uuid(),
  })
