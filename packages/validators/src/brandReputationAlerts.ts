 ...
 */
export const createReputationAlertRuleSchema = z
  .object({
  ...
  .refine(
    (data) => {
      ...
      if (
        data.minDeltaOverallScore !== undefined &&
        data.maxDeltaOverallScore !== undefined
      ) {
    ...
    {
      message:
        'minDeltaOverallScore must be less than or equal to maxDeltaOverallScore',
  ...
  .refine(
    (data) => {
      ...
      if (
        data.minCompetitorGap !== undefined &&
        data.maxCompetitorGap !== undefined
      ) {
    ...
    {
      message:
        'minCompetitorGap must be less than or equal to maxCompetitorGap',
...
export const listReputationAlertRulesQuerySchema = z.object({
  ...
  sortBy: z
    .enum(['name', 'createdAt', 'lastTriggeredAt'])
    .optional()
    .default('createdAt'),
...
export const listReputationAlertEventsQuerySchema = z.object({
  ...
  sortBy: z
    .enum(['triggeredAt', 'status', 'overallScoreAfter'])
    .optional()
    .default('triggeredAt'),
  sortOrder: z.enum(['asc', 'desc']).optional().default('desc'),
});
 ...
 */
export const createReputationReportSchema = z
  .object({
    ...
    format: reputationReportFormatSchema
      .optional()
 ...
 */
export const generateReputationReportSchema = z
  .object({
...
export const listReputationReportsQuerySchema = z.object({
  ...
  sortBy: z
    .enum(['createdAt', 'reportPeriodStart', 'status'])
    .optional()
    .default('createdAt'),
  sortOrder: z.enum(['asc', 'desc']).optional().default('desc'),
});
...
// Enum types
export type ReputationAlertChannelInput = z.input<
  typeof reputationAlertChannelSchema
>;
export type ReputationAlertChannelOutput = z.output<
  typeof reputationAlertChannelSchema
>;

export type ReputationAlertStatusInput = z.input<
  typeof reputationAlertStatusSchema
>;
export type ReputationAlertStatusOutput = z.output<
  typeof reputationAlertStatusSchema
>;

export type ReputationReportFrequencyInput = z.input<
  typeof reputationReportFrequencySchema
>;
export type ReputationReportFrequencyOutput = z.output<
  typeof reputationReportFrequencySchema
>;

export type ReputationReportFormatInput = z.input<
  typeof reputationReportFormatSchema
>;
export type ReputationReportFormatOutput = z.output<
  typeof reputationReportFormatSchema
>;

export type ReputationReportStatusInput = z.input<
  typeof reputationReportStatusSchema
>;
export type ReputationReportStatusOutput = z.output<
  typeof reputationReportStatusSchema
>;

export type ReputationReportSectionTypeInput = z.input<
  typeof reputationReportSectionTypeSchema
>;
export type ReputationReportSectionTypeOutput = z.output<
  typeof reputationReportSectionTypeSchema
>;

export type ReputationComponentKeyInput = z.input<
  typeof reputationComponentKeySchema
>;
export type ReputationComponentKeyOutput = z.output<
  typeof reputationComponentKeySchema
>;

// Rule types
export type CreateReputationAlertRuleInput = z.input<
  typeof createReputationAlertRuleSchema
>;
export type CreateReputationAlertRuleOutput = z.output<
  typeof createReputationAlertRuleSchema
>;

export type UpdateReputationAlertRuleInput = z.input<
  typeof updateReputationAlertRuleSchema
>;
export type UpdateReputationAlertRuleOutput = z.output<
  typeof updateReputationAlertRuleSchema
>;

export type ListReputationAlertRulesQueryInput = z.input<
  typeof listReputationAlertRulesQuerySchema
>;
export type ListReputationAlertRulesQueryOutput = z.output<
  typeof listReputationAlertRulesQuerySchema
>;

// Event types
export type ListReputationAlertEventsQueryInput = z.input<
  typeof listReputationAlertEventsQuerySchema
>;
export type ListReputationAlertEventsQueryOutput = z.output<
  typeof listReputationAlertEventsQuerySchema
>;

export type AcknowledgeReputationAlertEventInput = z.input<
  typeof acknowledgeReputationAlertEventSchema
>;
export type AcknowledgeReputationAlertEventOutput = z.output<
  typeof acknowledgeReputationAlertEventSchema
>;

export type ResolveReputationAlertEventInput = z.input<
  typeof resolveReputationAlertEventSchema
>;
export type ResolveReputationAlertEventOutput = z.output<
  typeof resolveReputationAlertEventSchema
>;

// Report types
export type CreateReputationReportInput = z.input<
  typeof createReputationReportSchema
>;
export type CreateReputationReportOutput = z.output<
  typeof createReputationReportSchema
>;

export type GenerateReputationReportInput = z.input<
  typeof generateReputationReportSchema
>;
export type GenerateReputationReportOutput = z.output<
  typeof generateReputationReportSchema
>;

export type RegenerateReputationReportSectionInput = z.input<
  typeof regenerateReputationReportSectionSchema
>;
export type RegenerateReputationReportSectionOutput = z.output<
  typeof regenerateReputationReportSectionSchema
>;

export type ListReputationReportsQueryInput = z.input<
  typeof listReputationReportsQuerySchema
>;
export type ListReputationReportsQueryOutput = z.output<
  typeof listReputationReportsQuerySchema
>;

// Insights types
export type GetReputationInsightsQueryInput = z.input<
  typeof getReputationInsightsQuerySchema
>;
export type GetReputationInsightsQueryOutput = z.output<
  typeof getReputationInsightsQuerySchema
>;

// Notification config type
export type AlertNotificationConfigInput = z.input<
  typeof alertNotificationConfigSchema
>;
export type AlertNotificationConfigOutput = z.output<
  typeof alertNotificationConfigSchema
>;
