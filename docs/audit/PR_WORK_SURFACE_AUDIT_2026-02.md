...
_Ship-blocker items. Must complete before next GA candidate._
...
_All text below 13px in semantic positions. Work file by file._
...
_Single coordinated PR across all files. Do not do piecemeal._
...
_Audit completed by Claude Sonnet 4.6 | PR Work Surface | DS v3.1 | February 2026_
