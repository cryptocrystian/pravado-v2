...
**Authority:** This doc reflects actual repo state. Canon docs define what things _should_ be.
...
_Single source of truth for build state. Canon docs (`/docs/canon/_`) remain the authority for what things should be.\*
