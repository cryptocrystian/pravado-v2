...
_This document is the authoritative spec for the Pravado admin dashboard._  
_All admin sprint work should reference it._  
_Build order: Phase 1 → Phase 2 → Phase 3 → Phase 4_
