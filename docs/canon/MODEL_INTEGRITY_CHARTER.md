...
| **CRAFT** (execution) | `CRAFT_v2.md` (D031 rename; was AUTOMATE_v2.md)     | governed execution pipeline | Turns SAGE proposals into governed, mode-aware, traceable tasks. No silent automation.                                        |
