...
## Pillars and Surfaces

- Work Surfaces: PR, Content, SEO
- Execution Surface: Cross-Pillar Orchestration Calendar
- Intelligence/Measurement: Analytics & Reporting (includes CiteMind)

## Intelligence Principles

- Automation must always be labeled, explainable, and interruptible.
- No silent automation.
- No dead-end drilldowns.

## Success Definition

Pravado functions as a self-optimizing visibility system:

- Users can run Manual → Copilot → Autopilot per pillar
- The platform proposes and executes coordinated actions across pillars
- Performance feedback influences future proposals (guardrailed, explainable)
