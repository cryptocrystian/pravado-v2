...
export async function journalistTimelineRoutes(fastify: FastifyInstance) {
  ...
  fastify.post<{
    ...
    async (
      request: FastifyRequest<{ Body: CreateTimelineEventInput }>,
      reply: FastifyReply
    ) => {
      try {
        const validationResult = CreateTimelineEventInputSchema.safeParse(
          request.body
        );
        ...
        fastify.log.error(
          { error, route: 'POST /journalist-timeline/events' },
  ...
  fastify.get<{
    ...
    async (
      ...
      try {
        ...
        fastify.log.error(
          { error, route: 'GET /journalist-timeline/events/:id' },
          'Failed to get timeline event'
        );
        return reply.status(500).send({
  ...
  fastify.patch<{
    ...
    async (
      ...
      try {
        const validationResult = UpdateTimelineEventInputSchema.safeParse(
          request.body
        );
        if (!validationResult.success) {
          return reply.status(400).send({
        ...
        fastify.log.error(
          { error, route: 'PATCH /journalist-timeline/events/:id' },
  ...
  fastify.delete<{
    ...
    async (
      ...
      try {
        ...
        fastify.log.error(
          { error, route: 'DELETE /journalist-timeline/events/:id' },
  ...
  fastify.get<{
    ...
    async (
      ...
      try {
        ...
        fastify.log.error(
          { error, route: 'GET /journalist-timeline/events' },
  ...
  fastify.get<{
    ...
    { onRequest: [requireUser] },
    async (
      request: FastifyRequest<{ Params: { journalistId: string } }>,
      reply: FastifyReply
    ) => {
      try {
        const user = (request as any).user;
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const stats = await timelineService.getStats(
          orgId,
        ...
        fastify.log.error(
          { error, route: 'GET /journalist-timeline/stats/:journalistId' },
          'Failed to get timeline stats'
        );
        return reply.status(500).send({
  ...
  fastify.get<{
    ...
    async (
      ...
      try {
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const healthScore = await timelineService.calculateHealthScore(
          orgId,
          request.params.journalistId
        );
        ...
        fastify.log.error(
          {
            error,
            route: 'GET /journalist-timeline/health-score/:journalistId',
          },
    ...
    async (
      ...
      try {
        ...
        if (!['day', 'week', 'month'].includes(period)) {
          return reply
            .status(400)
            .send({ error: 'Invalid period. Must be day, week, or month.' });
        }
        ...
        fastify.log.error(
          {
            error,
            route: 'GET /journalist-timeline/aggregation/:journalistId',
          },
          'Failed to get timeline aggregation'
        );
        return reply.status(500).send({
          error: 'Failed to get timeline aggregation',
          message: error.message,
        });
      }
    }
  ...
  fastify.post<{
    ...
    async (
      ...
      try {
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const clustersCreated = await timelineService.autoClusterEvents(
          orgId,
          request.params.journalistId
        );
        ...
        fastify.log.error(
          {
            error,
            route: 'POST /journalist-timeline/auto-cluster/:journalistId',
          },
          'Failed to auto-cluster events'
        );
        return reply.status(500).send({
          error: 'Failed to auto-cluster events',
          message: error.message,
        });
      }
    }
  ...
  fastify.get<{
    ...
    { onRequest: [requireUser] },
    async (
      request: FastifyRequest<{ Params: { clusterId: string } }>,
      reply: FastifyReply
    ) => {
      try {
        const user = (request as any).user;
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const cluster = await timelineService.getCluster(
          orgId,
        ...
        fastify.log.error(
          { error, route: 'GET /journalist-timeline/clusters/:clusterId' },
          'Failed to get cluster'
        );
        return reply
          .status(500)
          .send({ error: 'Failed to get cluster', message: error.message });
      }
    }
  );
  ...
  fastify.post<{
    ...
    { onRequest: [requireUser] },
    async (
      request: FastifyRequest<{ Body: BatchCreateTimelineEventsInput }>,
      reply: FastifyReply
    ) => {
      try {
        const validationResult = BatchCreateTimelineEventsInputSchema.safeParse(
          request.body
        );
        if (!validationResult.success) {
          return reply.status(400).send({
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const result = await timelineService.batchCreateEvents(
          orgId,
          input,
          user.id
        );
        ...
        fastify.log.error(
          { error, route: 'POST /journalist-timeline/batch' },
          'Failed to batch create events'
        );
        return reply.status(500).send({
          error: 'Failed to batch create events',
          message: error.message,
        });
      }
    }
  ...
  fastify.post<{
    ...
    { onRequest: [requireUser] },
    async (
      request: FastifyRequest<{ Body: CreateManualNoteInput }>,
      reply: FastifyReply
    ) => {
      try {
        const validationResult = CreateManualNoteInputSchema.safeParse(
          request.body
        );
        if (!validationResult.success) {
          return reply.status(400).send({
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const note = await timelineService.createManualNote(
          orgId,
          input,
          user.id
        );
        ...
        fastify.log.error(
          { error, route: 'POST /journalist-timeline/notes' },
          'Failed to create manual note'
        );
        return reply.status(500).send({
  ...
  fastify.post<{
    ...
    { onRequest: [requireUser] },
    async (
      request: FastifyRequest<{ Body: GenerateNarrativeInput }>,
      reply: FastifyReply
    ) => {
      try {
        const validationResult = GenerateNarrativeInputSchema.safeParse(
          request.body
        );
        if (!validationResult.success) {
          return reply.status(400).send({
        ...
        const narrativeService = new NarrativeGeneratorService(
          supabase,
          billingService,
          llmRouter
        );
        ...
        fastify.log.error(
          { error, route: 'POST /journalist-timeline/narrative' },
  ...
  fastify.post<{
    ...
    { onRequest: [requireUser] },
    async (
      request: FastifyRequest<{ Body: SystemEventPush }>,
      reply: FastifyReply
    ) => {
      try {
        ...
        const timelineService = new JournalistTimelineService(supabase);
        const timelineEvent = await timelineService.pushSystemEvent(
          orgId,
          event
        );
        ...
        fastify.log.error(
          { error, route: 'POST /journalist-timeline/push-event' },
          'Failed to push system event'
        );
        return reply.status(500).send({
          error: 'Failed to push system event',
          message: error.message,
        });
      }
    }
