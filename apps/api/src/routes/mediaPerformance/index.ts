    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const snapshot = await service.createSnapshot(
          orgId,
          validated as CreateSnapshotRequest
        );
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const filters: MediaPerformanceFilters =
          mediaPerformanceFiltersSchema.parse({
            ...
            minEviScore: queryParams.minEviScore
              ? Number(queryParams.minEviScore)
              : undefined,
  ...
  server.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const dimension = await service.createDimension(
          orgId,
          validated as CreateDimensionRequest
        );
  ...
  server.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const score = await service.upsertScore(
          orgId,
          validated as CreateScoreRequest
        );
      ...
      try {
        ...
        const filters: ScoreFilters = scoreFiltersSchema.parse({
          ...
          minScore: queryParams.minScore
            ? Number(queryParams.minScore)
            : undefined,
          maxScore: queryParams.maxScore
            ? Number(queryParams.maxScore)
            : undefined,
          startDate: queryParams.startDate,
          endDate: queryParams.endDate,
        });
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const insight = await service.createInsight(
          orgId,
          validated as CreateInsightRequest
        );
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const insight = await service.updateInsight(
          orgId,
          id,
          validated as UpdateInsightRequest
        );
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const filters: InsightFilters = insightFiltersSchema.parse({
          ...
          minImpactScore: queryParams.minImpactScore
            ? Number(queryParams.minImpactScore)
            : undefined,
          startDate: queryParams.startDate,
          endDate: queryParams.endDate,
        });
