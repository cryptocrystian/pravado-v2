...
export default async function competitorIntelligenceRoutes(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const competitor = await service.createCompetitor(
          orgId,
          validated as CreateCompetitorRequest
        );
  ...
  server.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const orgId = getOrgId(request);
        const validated = createCompetitorMentionRequestSchema.parse(
          request.body
        );
        const mention = await service.createMention(
          orgId,
          validated as CreateCompetitorMentionRequest
        );
  ...
  server.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const orgId = getOrgId(request);
        const validated = createCompetitorInsightRequestSchema.parse(
          request.body
        );
        const insight = await service.createInsight(
          orgId,
          validated as CreateCompetitorInsightRequest
        );
  ...
  server.patch(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        const orgId = getOrgId(request);
        const { id } = competitorIdParamSchema.parse(request.params);
        const validated = updateCompetitorInsightRequestSchema.parse(
          request.body
        );
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const insight = await service.generateInsight(
          orgId,
          validated as GenerateInsightRequest
        );
