...
const PLANS = [
  ...
  },
  {
    slug: 'pro',
    name: 'Pravado Pro',
    description: 'For professional teams with full SAGE + CiteMind + CRAFT',
    monthlyPriceCents: 59900, // $599/month
    features: [
      '15 team seats',
      'Unlimited SAGE actions',
      'Real-time CiteMind scanning',
      'Unlimited CRAFT executions',
      '5,000,000 LLM tokens/month',
      'Full journalist database',
      'Advanced analytics',
      'Priority support',
    ],
  },
  {
    ...
    features: [
      '50 team seats',
      'Everything in Pro',
      'Full 283K journalist database',
      '50,000,000 LLM tokens/month',
      '1-year EVI history',
