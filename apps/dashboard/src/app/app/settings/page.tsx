  ...
  return (
    <div className="p-4 rounded-lg bg-slate-3/30 border border-border-subtle">
      ...
      <div className="text-sm text-slate-11 mb-3">
        Import keyword data and search performance
      </div>
      {status === 'loading' ? (
        <span className="px-3 py-1.5 text-xs font-medium text-slate-10">
          Checking...
        </span>
      ) : status === 'connected' ? (
...
export default function SettingsPage() {
  ...
  const subPages = [
    ...
    },
    {
      ...
      href: '/app/settings/knowledge-base',
      icon: (
        <svg
          className="w-4 h-4"
          fill="none"
        ...
        <div className="flex gap-8">
          ...
          <div className="w-48 flex-shrink-0">
            ...
            <div className="mt-6 pt-4 border-t border-border-subtle">
              <p className="px-3 mb-2 text-[11px] font-medium text-white/40 uppercase tracking-wider">
                Configure
              </p>
              <nav className="space-y-1">
                {subPages.map((page) => (
            ...
            <div className="panel-card p-8">
              {activeTab === 'account' && (
                <div className="space-y-6">
                  ...
                  <p className="text-slate-11">
                    ...
                    provider. Changes to your profile, password, or security
                    settings should be made there.
                  </p>
                  <div className="p-4 rounded-lg bg-slate-3/30 border border-border-subtle">
              ...
              {activeTab === 'integrations' && (
                <div className="space-y-6">
                  ...
                  <p className="text-slate-11">
                    Connect external services to enhance your Pravado
                    experience.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    <GSCIntegrationCard />
                    {['Slack', 'HubSpot', 'Salesforce', 'Google Analytics'].map(
                      (integration) => (
                        <div
                          key={integration}
                          className="p-4 rounded-lg bg-slate-3/30 border border-border-subtle"
                        >
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        description: 'Get notified about new media coverage',
                      },
                      {
                        label: 'AI insights',
                        description:
                          'Daily AI-generated intelligence summaries',
                      },
                    ].map((pref) => (
                      <div
                        key={pref.label}
                        className="flex items-center justify-between p-4 rounded-lg bg-slate-3/30 border border-border-subtle"
                      >
                        <div>
                          <div className="font-medium text-white">
                            {pref.label}
