        ...
        >
          ...
          <div
            style={{
              ...
              opacity: 0.3,
              background:
                'radial-gradient(ellipse at 50% 0%, #FF6B6B 0%, transparent 50%)',
            }}
          />
          ...
          <div
            style={{
              ...
              textAlign: 'center',
              backgroundColor:
                'rgba(18, 25, 35, 0.7)' /* --slate-2 with opacity */,
              backdropFilter: 'blur(12px)',
              border:
                '1px solid rgba(255, 255, 255, 0.06)' /* --border-subtle */,
