...
const BETA_INVITE_REQUIRED =
  process.env.NEXT_PUBLIC_BETA_INVITE_REQUIRED === 'true';
...
export default function LoginPage() {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'azure') => {
    ...
    try {
      ...
      console.warn(
        '[OAuth] No redirect URL returned — Supabase may have redirected automatically'
      );
          ...
          <div className="auth-card p-8 space-y-8">
            ...
            <div className="text-center space-y-2">
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <AIPresenceDot
                  status={loading || oauthLoading ? 'analyzing' : 'idle'}
                />
              </div>
              <h1 className="text-xl font-semibold text-white">
