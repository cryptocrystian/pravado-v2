...
const quickNavCards: QuickNavCard[] = [
  {
    ...
    color: '#A855F7',
    description:
      'Strategic intelligence that reads every signal and ranks every action.',
  },
  {
    id: 'craft',
    name: 'CRAFT',
    color: '#00D9FF',
    description:
      'Execution engine that turns strategy into deployed, measurable actions.',
  },
  {
    id: 'citemind',
    name: 'CiteMind',
    color: '#E879F9',
    description:
      'Citation intelligence scanning every major AI engine in real time.',
  },
];
        ...
        return (
          <g key={e.label}>
            ...
            <line
              ...
              x2={nx - 22 * Math.cos(rad)}
              y2={ny - 22 * Math.sin(rad)}
              stroke={e.color}
              strokeWidth={1}
              strokeDasharray="3 2"
            />
            {/* Labels on lines */}
            <text
              x={midX + 12 * Math.cos(rad + 1.3)}
              y={midY + 12 * Math.sin(rad + 1.3)}
              textAnchor="middle"
    ...
    <div style={{ background: '#0A0A0F', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '100px 5%', background: '#0A0A0F' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          >
            SAGE&trade;, CRAFT&trade;, and CiteMind&trade; are not off-the-shelf
            wrappers. They are purpose-built engines designed to read the
            visibility landscape, execute across PR, Content, and SEO
            simultaneously, and measure real impact inside the AI models that
            increasingly decide who gets seen. Each engine is powerful on its
            own. Together, they form a closed loop where every action compounds
            and every signal feeds back.
          </p>
      ...
      >
        ...
        >
          ...
          >
            SAGE&trade; continuously reads over 50 signals across your PR
            coverage, content performance, search rankings, AI citations,
            competitor activity, and journalist engagement. It does not just
            collect data &mdash; it interprets the landscape and ranks every
            possible action by its projected EVI&trade; impact, so you always
          ...
          >
            Once SAGE&trade; has prioritized the highest-impact moves, it hands
            the ranked action queue directly to CRAFT&trade; for execution. No
            context is lost. No signal is wasted. The strategic intent flows
            seamlessly into deployed action, and every result feeds back into
      ...
      >
        ...
        >
          ...
          >
            CRAFT&trade; receives the ranked action queue from SAGE&trade; and
            builds complete execution plans across PR outreach, content
            creation, and SEO optimization. It does not simply list tasks
            &mdash; it constructs the full sequence: the pitch, the timing, the
            follow-up, the measurement criteria.
          </p>
          <p
            style={{
              maxWidth: 660,
          ...
          >
            Every plan passes through human review before deployment. You stay
            in control. Once approved, CRAFT&trade; deploys the action and
            immediately begins tracking the signal it creates &mdash; feeding
            results back through CiteMind&trade; and SAGE&trade; to close the
            loop and compound your visibility.
          </p>
      ...
      >
        ...
        >
          ...
          >
            CiteMind&trade; continuously scans ChatGPT, Perplexity, Claude,
            Gemini, and Google AI Overviews to track how and when your brand is
            cited in AI-generated answers. It monitors direct mentions, source
            citations, and topic associations &mdash; building a real-time map
            of your presence inside the models that increasingly shape buyer
            decisions.
          </p>
          <p
            style={{
          ...
          >
            Every citation event updates your EVI&trade; score and feeds
            directly back to SAGE&trade; for re-analysis. When CiteMind&trade;
            detects a gap &mdash; a competitor gaining citation share, a query
            category where you are absent &mdash; SAGE&trade; immediately
            re-ranks actions and CRAFT&trade; builds the response. The loop
            never stops.
          </p>
      ...
      <section style={{ padding: '80px 5%', background: '#0A0A0F' }}>
        ...
        >
          ...
          >
            SAGE&trade; reads the landscape. CRAFT&trade; executes.
            CiteMind&trade; measures. The loop compounds your visibility every
            cycle.
          </p>
          <div
            style={{
