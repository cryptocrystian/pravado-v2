  ...
  return (
    <div
      style={{
        ...
        boxShadow:
          '0 40px 80px rgba(168,85,247,0.12), 0 20px 40px rgba(0,0,0,0.5)',
      }}
    >
      {/* Browser chrome */}
      <div
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 8, color: '#22C55E' }}>
                  +3.4 this month
                </span>
              </div>
            </div>
            {/* Sub-scores */}
            {[
              { name: 'Visibility', score: 78.1 },
              { name: 'Authority', score: 71.3 },
              { name: 'Momentum', score: 68.5 },
            ].map((s) => (
              <div
                key={s.name}
                style={{
            ...
            {[
              {
                tag: 'PR',
                color: '#E879F9',
                text: 'Pitch TechCrunch re: AI visibility',
              },
              {
                tag: 'SEO',
                color: '#00D9FF',
                text: 'Optimize landing page for AEO',
              },
              {
                tag: 'Content',
                color: '#14B8A6',
                text: 'Rewrite "AI Search" article',
              },
              {
                tag: 'PR',
                color: '#E879F9',
                text: 'Follow up: Wired journalist',
              },
            ].map((a, i) => (
              <div
                key={i}
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 7, color: 'rgba(255,255,255,0.25)' }}
                  >
                    +{(3.2 - i * 0.5).toFixed(1)} EVI
                  </span>
                </div>
                <div
                  style={{
...
> = {
  PR: {
    ...
    label: 'EARNED MEDIA',
    headline:
      '283,597 journalists. SAGE\u2122 tells you which 3 to pitch today.',
    ...
    stats: [
      ...
      {
        n: '+5.2',
        label: 'avg EVI\u2122 points from a single TechCrunch placement',
      },
    ],
    variant: 'pr',
  },
  Content: {
    ...
    headline:
      'CiteMind\u2122 scans ChatGPT, Perplexity, Claude, and Gemini. 24/7.',
    ...
    stats: [
      {
        n: '4.4\u00d7',
        label: 'AI search traffic conversion rate vs. organic',
      },
  ...
  SEO: {
    ...
    stats: [
      ...
      {
        n: '$1T',
        label: 'in commerce projected to shift to AI assistants by 2029',
      },
    ],
    variant: 'seo',
  },
...
export default function MarketingPage() {
  ...
  const eviColor =
    eviValue < 30 ? '#EF4444' : eviValue < 60 ? '#F59E0B' : '#00D9FF';
    ...
    <div style={{ background: '#0A0A0F' }}>
      ...
      >
        ...
        <div style={{ position: 'relative', maxWidth: 820, margin: '0 auto' }}>
          ...
          >
            ...
            your brand, ignoring it, or sending buyers to your competitors. Most
            marketing teams have no idea which &mdash; and no way to change it.
          </p>
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
            ...
            {[
              {
                ...
                color: '#A855F7',
                pain: 'ChatGPT is sending traffic to my competitors. I can see it in analytics. I have no idea how to fix it \u2014 and neither does anyone on my team.',
              },
              {
                role: 'PR DIRECTOR',
                color: '#E879F9',
                pain: 'I got a TechCrunch placement. My CEO wants to know what it was worth in real business terms. My agency sent a PDF with impressions. That\u2019s not an answer anymore.',
              },
              {
                role: 'CONTENT / SEO MANAGER',
                color: '#14B8A6',
                pain: 'I published 30 articles last quarter. Two are being cited in AI answers. I don\u2019t know which two, why those two, or what I should write next.',
              },
            ].map(({ role, color, pain }) => (
              <div
                key={role}
          ...
          >
            <div>
              ...
              >
                Your PR team pitches journalists without knowing which
                placements move your AI visibility score. Your content team
                publishes without knowing which articles Perplexity actually
                cites. Your SEO team tracks rankings that may not translate to
                AI recommendations at all.
              </p>
              <p
                style={{
                  fontSize: 16,
              ...
              >
                Meanwhile, you&apos;re paying $40K/year for tools that
                don&apos;t talk to each other &mdash; and can&apos;t answer the
                only question that matters:
                <span style={{ color: '#ffffff', fontWeight: 600 }}>
                  {' '}
                  is my brand winning in AI?
                </span>
              </p>
              ...
              >
                ...
                {[
                  ...
                  },
                  {
                    name: 'CiteMind\u2122',
                    color: '#E879F9',
                    action: 'confirms it happened',
                  },
                  {
                    name: 'EVI\u2122',
                    color: '#22C55E',
                    action: 'tells you if it\u2019s working',
                  },
            ...
            >
              ...
              >
                {[
                  {
                    name: 'Cision',
                    purpose: 'Media database',
                    cost: '$10K/yr',
                  },
                  { name: 'Semrush', purpose: 'SEO tracking', cost: '$400/mo' },
                  {
                    name: 'Muck Rack',
                    purpose: 'Journalist intel',
                    cost: '$15K/yr',
                  },
                  {
                    name: 'BuzzSumo',
      ...
      >
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          >
            {['At Risk', 'Building', 'Strong', 'Elite'].map((l) => (
              <span key={l}>{l}</span>
            ))}
          </div>
          ...
          >
            EVI&trade; is Pravado&apos;s proprietary metric that unifies your
            PR, content, and SEO performance into a single score reflecting how
            prominently your brand appears in AI-generated responses. It&apos;s
            the first marketing metric that connects what you do to what AI says
            about you.
          </p>
      ...
      <section
        id="platform"
        style={{ padding: '100px 5%', background: '#0A0A0F' }}
      >
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div
            style={{
      ...
      <section style={{ padding: '100px 5%', background: '#0D0D14' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          >
            Most platforms give you data and leave execution to you. Pravado
            closes the loop &mdash; from signal detection to strategic guidance
          ...
          >
            <svg viewBox="0 0 600 520" style={{ width: '100%', maxWidth: 600 }}>
              <defs>
                <marker
                  ...
                  orient="auto"
                >
                  <path d="M0,1 L0,7 L7,4 z" fill="rgba(168,85,247,0.7)" />
                </marker>
                <marker
                  id="hm-arr-cyan"
                  markerWidth="8"
                  ...
                  orient="auto"
                >
                  <path d="M0,1 L0,7 L7,4 z" fill="rgba(0,217,255,0.7)" />
                </marker>
                <marker
                  id="hm-arr-mag"
                  markerWidth="8"
                  ...
                  orient="auto"
                >
                  <path d="M0,1 L0,7 L7,4 z" fill="rgba(232,121,249,0.7)" />
                </marker>
                <marker
                  id="hm-arr-grn"
                  markerWidth="8"
                  ...
                  orient="auto"
                >
                  <path d="M0,1 L0,7 L7,4 z" fill="rgba(34,197,94,0.5)" />
                </marker>
              </defs>
              {/* Layer labels */}
              <text
              ...
              {/* SAGE → CRAFT arrow */}
              <path
                d="M 310 133 L 310 188"
                stroke="rgba(168,85,247,0.5)"
                strokeWidth="1.5"
                markerEnd="url(#hm-arr-iris)"
              />
              <text
                x="318"
                y="165"
              ...
              <path
                d="M 310 258 L 310 313"
                stroke="rgba(0,217,255,0.5)"
                strokeWidth="1.5"
                markerEnd="url(#hm-arr-cyan)"
              />
              <text
                x="318"
                y="290"
              ...
              {/* CiteMind → EVI arrow */}
              <path
                d="M 310 383 L 310 428"
                stroke="rgba(232,121,249,0.5)"
                strokeWidth="1.5"
                markerEnd="url(#hm-arr-mag)"
              />
              <text
                x="318"
                y="410"
              ...
              {/* Feedback loop */}
              <path
                d="M 274 455 Q 80 455 80 230 Q 80 105 200 100"
                stroke="rgba(34,197,94,0.3)"
                strokeWidth="1"
                fill="none"
                strokeDasharray="5 4"
                markerEnd="url(#hm-arr-grn)"
              />
              <text
                x="58"
                y="280"
            ...
            <div>
              ...
              >
                SAGE&trade; operates at the strategy layer &mdash; reading
                signals, identifying gaps, ranking actions by EVI&trade; impact.
                CRAFT&trade; operates at the execution layer &mdash; building
                campaigns, drafting pitches, deploying content. CiteMind&trade;
                operates at the intelligence layer &mdash; scanning AI engines
                continuously, detecting every citation, feeding results back
                into EVI&trade;. Each layer informs the next. The loop never
                stops.
              </p>
              <div
            ...
            {[
              {
                name: 'SAGE\u2122',
                color: '#A855F7',
                desc: 'Analyzes 50+ signals daily. Surfaces your 3 highest-impact actions ranked by EVI\u2122 improvement.',
                href: '/models#sage',
              },
              {
                name: 'CRAFT\u2122',
                color: '#00D9FF',
                desc: 'Drafts pitches, sequences outreach, publishes briefs. SAGE\u2122 identifies, CRAFT\u2122 executes.',
                href: '/models#craft',
              },
              {
                name: 'CiteMind\u2122',
                color: '#E879F9',
                desc: 'Scans ChatGPT, Perplexity, Claude, Gemini 24/7. Every citation feeds back into EVI\u2122.',
                href: '/models#citemind',
              },
            ...
            {[
              {
                num: '01',
                label: 'Connect',
                desc: 'Link Google Search Console, your content library, and your PR history. Takes 5 minutes.',
                color: '#00D9FF',
              },
              {
                num: '02',
                label: 'Scan',
                desc: 'SAGE\u2122 scans AI engines 24/7 for citations, opportunities, and gaps. CiteMind\u2122 builds your visibility map.',
                color: '#A855F7',
              },
              {
                num: '03',
                label: 'Act',
                desc: 'Your Action Stream surfaces exactly what to do next, ranked by EVI\u2122 impact. CRAFT\u2122 executes.',
                color: '#E879F9',
              },
