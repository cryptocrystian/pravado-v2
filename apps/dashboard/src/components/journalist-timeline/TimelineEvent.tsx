...
> = {
  ...
  outreach_opened: {
    icon: '👀',
    color: 'bg-indigo-50 border-indigo-200',
    label: 'Outreach Opened',
  },
  outreach_clicked: {
    icon: '👆',
    color: 'bg-indigo-50 border-indigo-200',
    label: 'Outreach Clicked',
  },
  outreach_replied: {
    icon: '✅',
    color: 'bg-green-50 border-green-200',
  ...
  added_to_media_list: {
    ...
    label: 'Added to Media List',
  },
  removed_from_media_list: {
    icon: '➖',
    color: 'bg-pink-50 border-pink-200',
    label: 'Removed from Media List',
  },
  ...
  journalist_discovered: {
    ...
    label: 'Journalist Discovered',
  },
  discovery_merged: {
    icon: '🔗',
    color: 'bg-orange-50 border-orange-200',
    label: 'Discovery Merged',
  },
          ...
          <div className="flex items-center gap-1">
            ...
            <span
              className={`font-medium ${
                event.relationshipImpact > 0 ? 'text-green-600' : 'text-red-600'
              }`}
            >
              {event.relationshipImpact > 0 ? '+' : ''}
