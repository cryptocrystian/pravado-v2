...
/**
 * HoverCard Component (shadcn/ui style wrapper for Radix)
 *
 * Provides anchored popover on hover with configurable delays and arrow.
...
>(({ className, align = 'center', sideOffset = 4, ...props }, ref) => (
  <HoverCardPrimitive.Content
    ...
    className={cn(
      'z-50 w-72 rounded-lg border border-[#2A2A36] bg-[#0D0D12] p-4 shadow-xl shadow-black/30 outline-none',
...
>(({ className, ...props }, ref) => (
  <HoverCardPrimitive.Arrow
    ref={ref}
    className={cn('fill-[#0D0D12]', className)}
    {...props}
  />
));
