    ...
    return (
      <div className="p-4 text-center text-gray-500">
        ...
        <p className="text-xs mt-1">
          Generate the reality map to see outcome paths
        </p>
      </div>
    );
  }
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-2 py-0.5 rounded text-xs font-medium ${path.outcomeType ? getOutcomeTypeBadgeClass(path.outcomeType) : 'bg-gray-100 text-gray-700'}`}
                          >
                            {path.outcomeType
                              ? OUTCOME_TYPE_LABELS[path.outcomeType]
                              : 'Unknown'}
                          </span>
          ...
          <div className="p-3 space-y-3">
            {comparisons.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-xs mt-1">
                  Comparisons are generated during analysis
                </p>
              </div>
            ) : (
              comparisons.map((comparison) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Divergence Factors */}
                    {comparison.divergenceFactors &&
                      comparison.divergenceFactors.length > 0 && (
                        <div className="mb-3">
                          <h5 className="text-xs font-medium text-gray-700 mb-1">
                            Key Differences
                          </h5>
