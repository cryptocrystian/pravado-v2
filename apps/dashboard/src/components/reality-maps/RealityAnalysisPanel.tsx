    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <svg
            className="animate-spin w-8 h-8 mx-auto text-indigo-600 mb-3"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-3">
        ...
        {activeTab === 'risks' && <RisksTab risks={aggregatedRisks} />}
        {activeTab === 'opportunities' && (
      ...
      {universe.outcomeDistribution && (
        <div>
          ...
          <div className="space-y-1">
            {Object.entries(universe.outcomeDistribution).map(
              ([outcome, probability]) => (
        ...
        {universe.riskSummary && (
          <div className="border rounded-lg p-3">
            ...
            <div className="text-2xl font-bold text-red-600">
              {formatScore(
                universe.riskSummary.averageScore ?? universe.riskSummary.score
              )}
            </div>
            ...
            <div className="mt-2 text-xs">
              <span
                className={getRiskLevelBadgeClass(
                  getRiskLevel(
                    universe.riskSummary.maxScore ?? universe.riskSummary.score
                  )
                )}
              >
                Max:{' '}
        ...
        {universe.opportunitySummary && (
          <div className="border rounded-lg p-3">
            ...
            <div className="text-2xl font-bold text-green-600">
              {formatScore(
                universe.opportunitySummary.averageScore ??
                  universe.opportunitySummary.score
              )}
            </div>
            <div className="text-xs text-gray-500">Avg Score</div>
            <div className="mt-2 text-xs">
              <span
                className={getOpportunityLevelBadgeClass(
                  getOpportunityLevel(
                    universe.opportunitySummary.maxScore ??
                      universe.opportunitySummary.score
                  )
                )}
              >
