...
export function OutreachSequenceEditor({
  ...
  const [generatingStepIndex, setGeneratingStepIndex] = useState<number | null>(
    null
  );
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={maxRunsPerDay}
                  onChange={(e) =>
                    setMaxRunsPerDay(parseInt(e.target.value) || 50)
                  }
                  className="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500 outline-none"
                  min={1}
                  max={1000}
              ...
              <div>
                <label className="flex items-center gap-2 mt-7">
                  ...
                  <span className="text-sm">
                    Stop sequence on journalist reply
                  </span>
                </label>
              </div>
            </div>
                ...
                <div key={index} className="border rounded p-4 space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleUpdateStep(index, 'bodyTemplate', e.target.value)
                      }
                      className="w-full px-3 py-2 border rounded focus:ring-2 focus:ring-blue-500 outline-none"
                      rows={4}
