  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <span
          className={`ml-3 px-2.5 py-0.5 rounded-full text-xs font-medium ${getConflictStatusBadgeColor(conflict.status)}`}
        >
      ...
      {isResolved &&
        ...
        conflict.resolutions.length > 0 && (
          <div className="mb-4 flex items-center gap-2 text-sm text-green-600">
            ...
            Resolved with{' '}
            {conflict.resolutions[0].resolutionType.replace('_', ' ')}
          </div>
        )}
