...
export function SituationBrief({ compact, briefText }: SituationBriefProps) {
  ...
  if (compact) {
    return (
      <div
        className="flex items-stretch bg-slate-1 border-b border-border-subtle"
        ...
        <div className="flex items-center gap-4 px-5 flex-1 min-w-0">
          ...
          <div className="flex-shrink-0 flex flex-col items-center gap-1">
            <div className="flex items-center gap-1.5">
              <span
                className="w-1.5 h-1.5 rounded-full bg-brand-iris animate-pulse
  ...
  return (
    <div className="bg-cc-surface border border-white/8 rounded-2xl p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {briefText && <span className="text-xs text-white/45">Today</span>}
      </div>
