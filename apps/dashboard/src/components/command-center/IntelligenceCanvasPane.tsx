...
const MOCK_ENTITY_NODES: EntityNode[] = [
  // Ring 0 — Brand Core
  {
    ...
    linked_action_id: 'action-0',
    entity_insight: 'Brand core entity.',
    impact_pillars: [],
  ...
  // Ring 1 — Topic clusters (Owned)
  {
    ...
    entity_insight:
      'Highest schema coverage cluster. 14 published pieces, avg CiteMind score 7.8.',
    impact_pillars: ['SEO', 'AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Schema coverage at 62%. 3 pieces lack structured data — blocking Ring 3 connections.',
    impact_pillars: ['SEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Cluster exists but only 2 pieces published. Competitor B has 9 pieces on this topic.',
    impact_pillars: ['SEO', 'AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  // Ring 2 — Journalists / publications (Earned)
  {
    ...
    entity_insight:
      'Covers AI infrastructure at 3.2× frequency matching your target topics. Replied to 2 pitches this week.',
    impact_pillars: ['PR', 'AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Published 3 articles mentioning Pravado this month. DA 93 — strongest earned authority signal.',
    impact_pillars: ['PR', 'AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Pitch sent 3 days ago. No reply. Beat covers enterprise SaaS at 2.1× topic match.',
    impact_pillars: ['PR'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Forbes actively covers AI visibility platforms. Two journalists researching this topic — no Pravado connection yet.',
    impact_pillars: ['PR', 'AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  // Ring 3 — AI engines (Perceived)
  {
    ...
    entity_insight:
      'Cites Pravado in 69% of AI marketing automation queries. Highest citation rate across all engines.',
    impact_pillars: ['AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Citations up 18% this week. TechCrunch coverage directly correlates with GPT citation increase.',
    impact_pillars: ['AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Present in Gemini responses but citation quality score is 5.2/10 — structured data gaps limiting context quality.',
    impact_pillars: ['AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'Minimal citation presence. Entity disambiguation needed — Pravado not yet distinct in Anthropic knowledge graph.',
    impact_pillars: ['AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
  {
    ...
    entity_insight:
      'No confirmed citations. Bing favors structured FAQ schema — 3 FAQ gaps identified by CiteMind.',
    impact_pillars: ['AEO'],
    last_updated: new Date().toISOString(),
    meta: {},
  },
...
export function IntelligenceCanvasPane({
  ...
  const { results: citationResults } = useCitationResults({
    mentionedOnly: true,
    days: 30,
    limit: 20,
  });
  ...
  return (
    <div className="h-full flex flex-col">
        ...
        <div className="relative flex-1 min-h-0 flex items-center justify-center">
          ...
          >
            ...
            {activeTab === 'orchestration_editor' && (
              <div className="flex items-center justify-center h-full text-white/30">
                <div className="text-center">
                  <p className="text-sm font-medium">Orchestration Editor</p>
                  <p className="text-xs mt-1 text-white/20">Coming in V2</p>
                </div>
              </div>
            )}
            {activeTab === 'synergy_flow' && (
              <div className="flex items-center justify-center h-full text-white/30">
                <div className="text-center">
                  <p className="text-sm font-medium">Synergy Flow</p>
                  <p className="text-xs mt-1 text-white/20">Coming in V2</p>
                </div>
              </div>
            )}
          ...
          {activeTab === 'entity_map' && (
            <div
              className="absolute left-3 bottom-4 flex flex-col gap-1.5 pointer-events-none z-10"
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold uppercase tracking-wide text-white/60 inline-flex items-center gap-1">
                CiteMind&trade; Feed
                <InfoTooltip
                  content="CiteMind continuously scans ChatGPT, Perplexity, Claude, and Gemini to find citations of your brand, content, and competitors. Connect GSC to correlate AI citations with your organic search performance."
                  size={11}
                />
              </span>
            </div>
          ...
          <div className="flex-1 overflow-y-auto cc-scrollbar px-3 py-2 space-y-2">
            {displayCitations.length > 0 ? (
              displayCitations.map((c) => (
                ...
                >
                  <span
                    className="flex-shrink-0 px-2 py-0.5 text-xs font-bold rounded"
                    style={{
                      background: c.platformColor + '20',
              ...
              <div className="flex flex-col items-center justify-center py-6 px-5">
                ...
                <p className="text-xs text-white/50 text-center leading-relaxed mb-4">
                  Connect Google Search Console to import your actual search
                  keywords, impressions, and click data. This powers SAGE&apos;s
                  topic recommendations and makes your CiteMind score reflect
      ...
      {isFullscreen && (
        ...
        >
          <div
            className="relative bg-page border border-border-subtle rounded-xl overflow-hidden"
