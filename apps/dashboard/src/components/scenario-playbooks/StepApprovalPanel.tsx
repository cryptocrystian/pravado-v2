...
export function StepApprovalPanel({
  ...
  const statusLabel =
    SCENARIO_STEP_STATUS_LABELS[runStep.status as ScenarioStepStatus] ||
    runStep.status;
  const statusColor =
    STEP_STATUS_COLORS[runStep.status as ScenarioStepStatus] ||
    'bg-gray-100 text-gray-800';
  const actionLabel = playbookStep
    ? SCENARIO_STEP_ACTION_TYPE_LABELS[playbookStep.actionType] ||
      playbookStep.actionType
    : 'Unknown';
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        ...
        {playbookStep?.actionPayload &&
          Object.keys(playbookStep.actionPayload).length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-1">
                Action Details
              </h4>
        ...
        {runStep.executionContext &&
          Object.keys(runStep.executionContext).length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-1">
                Execution Context
              </h4>
        ...
        {runStep.simulatedImpact &&
          Object.keys(runStep.simulatedImpact).length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-1">
                Simulated Impact
              </h4>
        ...
        {playbookStep?.approvalRoles &&
          playbookStep.approvalRoles.length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-1">
