...
export function BoardInvestorUpdate({
  orgName,
  period,
}: BoardInvestorUpdateProps) {
  const lastEvi = mockEVITrend[mockEVITrend.length - 1]?.evi ?? 0;
  const theirEvi =
    mockCompetitorTrend[mockCompetitorTrend.length - 1]?.evi ?? 0;
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: 32 }}>
        ...
        <p
          style={{ fontSize: 64, fontWeight: 800, color: '#00D9FF', margin: 0 }}
        >
          {lastEvi.toFixed(1)}
        </p>
        <div
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: '#00D9FF',
                  borderRadius: 3,
                  opacity: 0.5 + (i / mockEVITrend.length) * 0.5,
                }}
              />
            );
          })}
      ...
      <div style={{ display: 'flex', gap: 24, marginBottom: 32 }}>
        ...
        >
          ...
          <p
            style={{ fontSize: 36, fontWeight: 800, color: '#666', margin: 0 }}
          >
            {theirEvi.toFixed(1)}
          </p>
        </div>
      ...
      {mockTopWins.map((win, i) => (
        ...
        >
          ...
          <p
            style={{ fontSize: 13, lineHeight: 1.5, color: '#333', margin: 0 }}
          >
            {win}
          </p>
        </div>
