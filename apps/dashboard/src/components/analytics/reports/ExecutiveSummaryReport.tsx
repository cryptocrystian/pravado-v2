  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1
          style={{ fontSize: 28, fontWeight: 800, margin: 0, color: '#1a1a2e' }}
        >
          Monthly Executive Summary
        </h1>
        <p style={{ fontSize: 14, color: '#666', margin: '8px 0 0' }}>
          {orgName} &middot; {period} &middot; Generated{' '}
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          <span style={{ fontSize: 56, fontWeight: 800, color: '#00D9FF' }}>
            {lastEvi.toFixed(1)}
          </span>
          <span
            style={{
              fontSize: 20,
              fontWeight: 600,
              color: Number(eviDelta) >= 0 ? '#22C55E' : '#EF4444',
            }}
          >
            {Number(eviDelta) >= 0 ? '+' : ''}
            {eviDelta} pts
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          {[
            { label: 'EVI Change', value: hm.eviChange.value },
            {
              ...
              value: String(hm.contentPublished.value),
            },
            {
              label: 'Earned Placements',
              value: String(hm.earnedPlacements.value),
            },
