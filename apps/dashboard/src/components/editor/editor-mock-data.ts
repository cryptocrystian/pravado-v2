...
export const mockBriefContext: BriefContext = {
  ...
  angle:
    'Differentiate with proprietary data and first-party case studies that competitors lack.',
  competitorContext:
    'CompetitorX published similar content 2 weeks ago and is cited by ChatGPT in 68% of related queries.',
};
...
export const mockCitationSignals: CitationSignal[] = [
  ...
  {
    engine: 'Perplexity',
    query: 'enterprise content strategy AI',
    cited: true,
    position: 1,
    trend: 'stable',
  },
  ...
  {
    engine: 'Claude',
    query: 'share of model measurement',
    cited: true,
    position: 3,
    trend: 'new',
  },
...
export const mockDerivatives: DerivativeItem[] = [
  ...
  },
  {
    id: 'deriv-3',
    type: 'thread',
    title: 'Twitter/X thread (8 posts)',
    status: 'pending',
    platform: 'X',
  },
  {
...
export const mockCrossPillarHooks: CrossPillarHook[] = [
  {
    ...
    description:
      "This article's data supports a trend piece on enterprise AI visibility strategies.",
    matches: [
  ...
  },
  {
    ...
    description:
      'Adding this entity could improve Gemini citation probability by ~15%.',
  },
];
...
export const slashCommands: SlashCommand[] = [
  ...
  },
  {
    ...
    description: 'Generate a new paragraph on the topic',
    iconName: 'Paragraph',
    category: 'ai-generate',
  },
  {
    ...
    description: 'Generate a full section with heading',
    iconName: 'Article',
    category: 'ai-generate',
  },
  {
  ...
  },
  {
    id: 'callout',
    name: 'Callout box',
    description: 'Insert a highlighted callout',
    iconName: 'Info',
    category: 'insert',
  },
  {
  ...
  },
  {
    id: 'h3',
    name: 'Heading 3',
    description: 'Insert a sub-heading',
    iconName: 'TextHThree',
    category: 'structure',
    shortcut: '###',
  },
  ...
  // Brand
  {
    ...
    description: 'Rewrite in your brand voice',
    iconName: 'Microphone',
    category: 'brand',
  },
];
