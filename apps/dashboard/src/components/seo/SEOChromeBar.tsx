...
> = {
  manual: {
    ...
    badge: 'bg-slate-4 text-white/70',
  },
  copilot: {
    label: 'Copilot',
  ...
  autopilot: {
    ...
    Icon: Cpu,
    iconClass: 'text-brand-iris',
    badge: 'bg-brand-iris/15 text-brand-iris',
  },
};
...
function ModeSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          className="absolute right-0 top-full mt-2 w-64 bg-slate-2 border border-slate-4 rounded-2xl shadow-elev-3 z-50 overflow-hidden"
          ...
          {(
            ...
            return (
              ...
              >
                <Icon
                  size={16}
                  className={`mt-0.5 flex-shrink-0 ${c.iconClass}`}
                />
