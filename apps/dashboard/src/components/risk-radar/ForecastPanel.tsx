  ...
  return (
    <Card className={className}>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Confidence Interval */}
        {forecast.confidenceIntervalLow !== undefined &&
          forecast.confidenceIntervalHigh !== undefined && (
            <div className="text-sm text-gray-600">
              <Target className="h-4 w-4 inline mr-1" />
              Confidence interval: {forecast.confidenceIntervalLow.toFixed(
                0
              )} - {forecast.confidenceIntervalHigh.toFixed(0)}
            </div>
          )}
