    ...
    <div className="bg-cc-surface border border-white/8 rounded-2xl p-6 mt-4">
      ...
      <div className="flex items-center gap-2 mb-6">
        {[1, 2, 3, 4].map((s) => (
          <div key={s} className="flex items-center gap-2">
            ...
            {s < 4 && (
              <div
                className={`w-8 h-px ${s < step ? 'bg-emerald-500/30' : 'bg-white/8'}`}
              />
            )}
          </div>
        ))}
      ...
      {step === 2 && (
        <div>
          ...
          <p className="text-xs text-white/45 mb-4">
            Use 3\u20135 examples of your best content for most accurate
            calibration
          </p>
        ...
        <div>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-start gap-3">
              <span className="text-xs text-white/45 w-28 flex-shrink-0 pt-0.5">
                Tone
              </span>
            ...
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm text-white">
                {mockBrandVoice.vocabularyLevel}
              </span>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-xs text-white/45 w-28 flex-shrink-0 pt-0.5">
        ...
        <div>
          ...
          <div className="bg-cc-page border border-white/8 rounded-xl p-4 mb-4">
            ...
            <p className="text-xs text-white/70">
              {mockBrandVoice.tone} &middot; {mockBrandVoice.sentenceLength}{' '}
              &middot; {mockBrandVoice.perspective}
            </p>
