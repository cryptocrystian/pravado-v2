    ...
    >
      ...
      <View style={[s.card, s.briefCard]}>
        <View style={s.briefHeader}>
          <View style={s.sagePill}>
            <Text style={s.sagePillText}>SAGE ACTIVE</Text>
          </View>
        </View>
        <Text style={s.briefText}>
          {dailyBrief ||
            'SAGE is analyzing your signals. Your first daily brief will appear once enough data has been collected.'}
        </Text>
      </View>
      ...
      <View style={s.section}>
        ...
        {pending.length === 0 ? (
          <EmptyState
            ...
            title="All caught up"
            subtitle="SAGE is monitoring your signals"
          />
        ) : (
          pending
            .slice(0, 3)
