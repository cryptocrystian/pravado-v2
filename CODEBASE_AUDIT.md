...
| PR Intelligence | 46     | journalists, media*outlets, pr_pitch_sequences, pr_outreach*_, media*monitoring*_, media_briefings, earned_mentions |
...
| Executive       | 15     | exec*digests, exec_board_reports, investor*\*                                                                       |
| Intelligence    | 28     | competitors, brand*reputation*\_, strategic\_\_, unified\_\*, reality_maps                                          |
| Scenario/Sim    | 20     | scenario*playbook*_, ai*scenario*_, scenario*orchestration*\*                                                       |
